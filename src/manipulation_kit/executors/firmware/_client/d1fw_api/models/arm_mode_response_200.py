...
T = TypeVar("T", bound="ArmModeResponse200")


@_attrs_define
class ArmModeResponse200:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        arm_mode_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        arm_mode_response_200.additional_properties = d
        return arm_mode_response_200
