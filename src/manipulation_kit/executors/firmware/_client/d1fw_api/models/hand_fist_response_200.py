...
T = TypeVar("T", bound="HandFistResponse200")


@_attrs_define
class HandFistResponse200:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        hand_fist_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        hand_fist_response_200.additional_properties = d
        return hand_fist_response_200
