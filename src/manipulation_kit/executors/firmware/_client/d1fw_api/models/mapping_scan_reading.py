...
if TYPE_CHECKING:
    from ..models.mapping_scan import MappingScan


T = TypeVar("T", bound="MappingScanReading")


@_attrs_define
class MappingScanReading:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.payload, MappingScan):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        def _parse_payload(data: object) -> MappingScan | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                payload_type_1 = MappingScan.from_dict(data)

                return payload_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MappingScan | None, data)
        ...
        mapping_scan_reading.additional_properties = d
        return mapping_scan_reading
