...
T = TypeVar("T", bound="ChassisProbeResponse200")


@_attrs_define
class ChassisProbeResponse200:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        chassis_probe_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        chassis_probe_response_200.additional_properties = d
        return chassis_probe_response_200
