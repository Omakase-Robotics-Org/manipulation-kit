...
T = TypeVar("T", bound="NeckHomeResponse200")


@_attrs_define
class NeckHomeResponse200:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        neck_home_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        neck_home_response_200.additional_properties = d
        return neck_home_response_200
