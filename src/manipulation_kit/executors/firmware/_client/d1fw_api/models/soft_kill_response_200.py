...
if TYPE_CHECKING:
    from ..models.soft_kill_report import SoftKillReport


T = TypeVar("T", bound="SoftKillResponse200")


@_attrs_define
class SoftKillResponse200:
    """
    Attributes:
        data (SoftKillReport): The outcome of one whole soft kill.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        data = SoftKillReport.from_dict(d.pop("data"))
        ...
        soft_kill_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        soft_kill_response_200.additional_properties = d
        return soft_kill_response_200
