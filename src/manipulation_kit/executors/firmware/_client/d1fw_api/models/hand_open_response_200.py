...
T = TypeVar("T", bound="HandOpenResponse200")


@_attrs_define
class HandOpenResponse200:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        hand_open_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        hand_open_response_200.additional_properties = d
        return hand_open_response_200
