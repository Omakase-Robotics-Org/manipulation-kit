...
T = TypeVar("T", bound="ChassisNavigationResponse200")


@_attrs_define
class ChassisNavigationResponse200:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        chassis_navigation_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        chassis_navigation_response_200.additional_properties = d
        return chassis_navigation_response_200
