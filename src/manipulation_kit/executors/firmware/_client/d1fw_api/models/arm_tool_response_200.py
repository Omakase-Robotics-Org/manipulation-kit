...
T = TypeVar("T", bound="ArmToolResponse200")


@_attrs_define
class ArmToolResponse200:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        arm_tool_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        arm_tool_response_200.additional_properties = d
        return arm_tool_response_200
