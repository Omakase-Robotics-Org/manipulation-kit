...
T = TypeVar("T", bound="NeckCmdResponse200")


@_attrs_define
class NeckCmdResponse200:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        neck_cmd_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        neck_cmd_response_200.additional_properties = d
        return neck_cmd_response_200
