...
T = TypeVar("T", bound="EyesCmdResponse200")


@_attrs_define
class EyesCmdResponse200:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        eyes_cmd_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        eyes_cmd_response_200.additional_properties = d
        return eyes_cmd_response_200
