...
T = TypeVar("T", bound="ArmEstopResponse200")


@_attrs_define
class ArmEstopResponse200:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        arm_estop_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        arm_estop_response_200.additional_properties = d
        return arm_estop_response_200
