...
T = TypeVar("T", bound="HandSetResponse200")


@_attrs_define
class HandSetResponse200:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        hand_set_response_200 = cls(
            data=data,
            message=message,
            status=status,
        )

        hand_set_response_200.additional_properties = d
        return hand_set_response_200
