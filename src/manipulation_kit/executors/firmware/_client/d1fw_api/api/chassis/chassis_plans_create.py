...
from ...models.chassis_plans_create import ChassisPlansCreate
from ...models.chassis_plans_create_response_200 import ChassisPlansCreateResponse200
...
def _get_kwargs(
    *,
    body: ChassisPlansCreate,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/chassis/plans/create",
    }
...
) -> ChassisPlansCreateResponse200 | ErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = ChassisPlansCreateResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ChassisPlansCreateResponse200 | ErrorEnvelope]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Create inactive normal-scene saved plans
    ...
    Args:
        body (ChassisPlansCreate): Append one inactive timed plan after fresh collection
            comparison.
...
def sync(
    *,
    ...
    Returns:
        ChassisPlansCreateResponse200 | ErrorEnvelope
    """
