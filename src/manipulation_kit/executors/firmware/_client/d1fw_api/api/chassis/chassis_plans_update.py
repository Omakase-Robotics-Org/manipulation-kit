...
from ...models.chassis_plans_update import ChassisPlansUpdate
from ...models.chassis_plans_update_response_200 import ChassisPlansUpdateResponse200
...
def _get_kwargs(
    *,
    body: ChassisPlansUpdate,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/chassis/plans/update",
    }
...
) -> ChassisPlansUpdateResponse200 | ErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = ChassisPlansUpdateResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ChassisPlansUpdateResponse200 | ErrorEnvelope]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Update inactive normal-scene saved plans
    ...
    Args:
        body (ChassisPlansUpdate): Replace a selected inactive plan after collection and target
            checks.
...
def sync(
    *,
    ...
    Returns:
        ChassisPlansUpdateResponse200 | ErrorEnvelope
    """
