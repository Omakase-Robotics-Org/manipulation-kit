...
from ...models.chassis_common_files_list import ChassisCommonFilesList
from ...models.chassis_common_files_list_response_200 import (
...
def _get_kwargs(
    *,
    body: ChassisCommonFilesList,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/chassis/common_files/list",
    }
...
) -> ChassisCommonFilesListResponse200 | ErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = ChassisCommonFilesListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ChassisCommonFilesListResponse200 | ErrorEnvelope]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List opaque common-file storage
    ...
    Args:
        body (ChassisCommonFilesList): One explicit manufacturer directory selector, not an
            inferred type inventory.
...
def sync(
    *,
    ...
    Returns:
        ChassisCommonFilesListResponse200 | ErrorEnvelope
    """
