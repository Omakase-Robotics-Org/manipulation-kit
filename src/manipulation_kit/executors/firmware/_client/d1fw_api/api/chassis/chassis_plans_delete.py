...
from ...models.chassis_plans_delete import ChassisPlansDelete
from ...models.chassis_plans_delete_response_200 import ChassisPlansDeleteResponse200
...
def _get_kwargs(
    *,
    body: ChassisPlansDelete,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/chassis/plans/delete",
    }
...
) -> ChassisPlansDeleteResponse200 | ErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = ChassisPlansDeleteResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ChassisPlansDeleteResponse200 | ErrorEnvelope]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Delete inactive normal-scene saved plans
    ...
    Args:
        body (ChassisPlansDelete): Delete exactly one inactive plan; all remaining IDs may change.
...
def sync(
    *,
    ...
    Returns:
        ChassisPlansDeleteResponse200 | ErrorEnvelope
    """
