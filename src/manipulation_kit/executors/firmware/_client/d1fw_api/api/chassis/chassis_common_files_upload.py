...
from ...models.chassis_common_file_upload import ChassisCommonFileUpload
from ...models.chassis_common_files_upload_response_200 import (
...
def _get_kwargs(
    *,
    body: ChassisCommonFileUpload,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/chassis/common_files/upload",
    }
...
) -> ChassisCommonFilesUploadResponse200 | ErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = ChassisCommonFilesUploadResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ChassisCommonFilesUploadResponse200 | ErrorEnvelope]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Upload opaque common-file storage
    ...
    Args:
        body (ChassisCommonFileUpload): Create after a fresh successful listing excludes the exact
            basename.
...
def sync(
    *,
    ...
    Returns:
        ChassisCommonFilesUploadResponse200 | ErrorEnvelope
    """
