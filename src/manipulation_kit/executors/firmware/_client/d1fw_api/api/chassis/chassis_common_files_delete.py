...
from ...models.chassis_common_file_delete import ChassisCommonFileDelete
from ...models.chassis_common_files_delete_response_200 import (
...
def _get_kwargs(
    *,
    body: ChassisCommonFileDelete,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/chassis/common_files/delete",
    }
...
) -> ChassisCommonFilesDeleteResponse200 | ErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = ChassisCommonFilesDeleteResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ChassisCommonFilesDeleteResponse200 | ErrorEnvelope]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Delete opaque common-file storage
    ...
    Args:
        body (ChassisCommonFileDelete): Delete one exact listed file after fresh current-content
            comparison.
...
def sync(
    *,
    ...
    Returns:
        ChassisCommonFilesDeleteResponse200 | ErrorEnvelope
    """
