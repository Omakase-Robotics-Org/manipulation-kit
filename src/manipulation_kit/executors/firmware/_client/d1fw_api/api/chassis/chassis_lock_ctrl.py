...
from ...models.chassis_lock_ctrl_response_200 import ChassisLockCtrlResponse200
from ...models.error_envelope import ErrorEnvelope
from ...models.lock_ctrl_request import LockCtrlRequest
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ChassisLockCtrlResponse200.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        ChassisLockCtrlResponse200 | ErrorEnvelope
    """
