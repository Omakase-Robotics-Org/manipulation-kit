...
from ...models.chassis_common_file_replace import ChassisCommonFileReplace
from ...models.chassis_common_files_replace_response_200 import (
...
def _get_kwargs(
    *,
    body: ChassisCommonFileReplace,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/chassis/common_files/replace",
    }
...
) -> ChassisCommonFilesReplaceResponse200 | ErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = ChassisCommonFilesReplaceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ChassisCommonFilesReplaceResponse200 | ErrorEnvelope]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Replace opaque common-file storage
    ...
    Args:
        body (ChassisCommonFileReplace): Replace an exact listed file after current raw-content
            revision comparison.
...
def sync(
    *,
    ...
    Returns:
        ChassisCommonFilesReplaceResponse200 | ErrorEnvelope
    """
