...
from ...models.chassis_battery_response_200 import ChassisBatteryResponse200
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ChassisBatteryResponse200.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        ChassisBatteryResponse200 | ErrorEnvelope
    """
