"""the arm vendor D1 arm arm (as mounted on D1) — the vendor binding.
...
``the arm vendor's SDK shared library``, the route every hand on the arm flange reached the wire
