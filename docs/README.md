...
| [`GESTURES.md`](GESTURES.md) | The gesture CSV format and the record → preview → play workflow the `scripts/` produce for. From d1-sdk `devices/omakase_arm/GESTURES.md`. | generating or playing a gesture |
