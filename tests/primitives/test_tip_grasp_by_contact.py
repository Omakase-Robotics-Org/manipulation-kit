...
def _right_home_deg():
    """The right arm stood at HOME in the live run; read it from the canonical
    ...
    return tuple(round(float(v), 2) for v in _json.load(open(cfg))["home_pose"][7:14])
